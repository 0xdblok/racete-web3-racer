...
export function resolveCarGameplayStats(
  ...
  const MAX_SPEED_SCALE = 0.75;     // was 0.85 — reduced for slower feel
  const ACCELERATION_SCALE = 0.10;  // was 0.13 — reduced
  const NITRO_POWER_SCALE = 0.17;   // was 0.20 — reduced
  const STEERING_SCALE = 0.13;      // unchanged
